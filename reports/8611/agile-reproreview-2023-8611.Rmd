...
### Figure 1
The reproduced figure is quite similar to the one included in the paper, but not exactly the same. There are some differences of aesthetic nature, such as the font and the color scheme, that appears slightly lighter on the reproduced figure. The original figure does not have a title (minor importance) and the explanations of some symbols are missing in the legend on the bottom right corner.
