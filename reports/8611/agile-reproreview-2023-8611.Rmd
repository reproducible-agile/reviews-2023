...
```{r, echo=FALSE,out.width="100%",fig.cap="Corresponds to Figure 2 of the paper",fig.show='hold',fig.align='center'}
...
```{r, echo=FALSE,out.width="85%",results='asis'}
...
- multiple rounds of communication, requirements were not clear from the beginning


## Reproduction efforts

- reproduction efforts: a lot of time, due to wrong (or lack of) instructions
